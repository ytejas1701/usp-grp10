...
const Login = ()=>{
    ...
    const validateForm = ()=>{
        ...
        if(!password){ setPasswordMessage('Please enter the password'); result=false;}
    ...
    const submitHandler = async (event)=>{
        ...
        if(validateForm()){
            try {
                ...
                if(error.code==='auth/user-not-found') setEmailMessage("This email has not been registered.")
                if(error.code==='auth/wrong-password') setPasswordMessage("Incorrect Password.")
            }
        }
    }
